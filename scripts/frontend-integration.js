 ...
 * This file demonstrates how to integrate Thrivejolt with a web frontend
 */

// For React/Vue/Angular applications
export class ThrivejoltClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ThrivejoltClient(provider, contractAddress);
